...
namespace approvefreight_api.Controllers
{
    ...
    public class ProtocolController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<protocol_redchannel_response>> GetRedChannels([FromQuery] string authorization, 
        ...
        [HttpGet]
        public async Task<ActionResult<protocol_unsuccessful_collection_response>> GetUnsuccessfulCollection([FromQuery] string authorization,
            [FromQuery] int cod_unidade_empresa, [FromQuery] int cod_empresa,
            [FromQuery] int cod_transportadora, [FromQuery] string sgl_unidade_federacao, [FromQuery] int cod_canal_venda)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<protocol_expensive_shipping_response>> GetExpensiveShipping([FromQuery] string authorization,
            [FromQuery] int cod_unidade_empresa, [FromQuery] int cod_empresa,
            [FromQuery] int cod_transportadora, [FromQuery] string sgl_unidade_federacao, [FromQuery] int cod_canal_venda)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<protocol_ocurrences_response>> GetOcurrences([FromQuery] string authorization,
            [FromQuery] int cod_unidade_empresa, [FromQuery] int cod_empresa,
            [FromQuery] int cod_transportadora, [FromQuery] string sgl_unidade_federacao, [FromQuery] int cod_canal_venda)
        {
            ...
            //var token = authorization.Substring("Bearer".Length).Trim();
            string useremail = TokenManager.ValidateToken(authorization);
        ...
        [HttpGet]
        public async Task<ActionResult<protocol_weight_response>> GetProtocolsWeight([FromQuery] string authorization,
            [FromQuery] int cod_unidade_empresa, [FromQuery] int cod_empresa,
            [FromQuery] int cod_transportadora, [FromQuery] string sgl_unidade_federacao, [FromQuery] int cod_canal_venda)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<protocol_ocurrences_revalidation_response>> GetOcurrencesRevalidation([FromQuery] string authorization,
