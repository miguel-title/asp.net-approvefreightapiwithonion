...
using apiwithonion.Infrastructure.Mapping;
using apiwithonion.Persistence;
using apiwithonion.Service.Contract;
using apiwithonion.Service.Implementation;
using AutoMapper;
...
namespace apiwithonion.Infrastructure.Extension
{
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            serviceCollection.AddDbContext<ApplicationDbContext>(options =>
                   options.UseSqlServer(configuration.GetConnectionString("TMSConnection") ?? configRoot["ConnectionStrings:TMSConnection"]
        ...
        public static void AddHealthCheck(this IServiceCollection serviceCollection, AppSettings appSettings, IConfiguration configuration)
        {
            serviceCollection.AddHealthChecks()
                ...
                .AddSqlServer(configuration.GetConnectionString("TMSConnection"));
